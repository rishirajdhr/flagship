                          ...
                          <button className="group flex cursor-pointer items-center justify-center">
                            ...
                            <span className="relative size-6">
                              <svg
                                ...
                                strokeWidth={1.5}
                                stroke="currentColor"
                                className="absolute top-0 left-0 size-6 text-gray-600 opacity-100 transition-opacity group-hover:opacity-0"
                              >
                                <path
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                              ...
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                className="absolute top-0 left-0 size-6 text-orange-500 opacity-0 transition-opacity group-hover:opacity-100"
                              >
                          ...
                          <button className="group flex cursor-pointer items-center justify-center">
                            ...
                            <span className="relative size-6">
                              ...
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                className="absolute top-0 left-0 size-6 text-red-500 opacity-0 transition-opacity group-hover:opacity-100"
                              >
                                <path
                                  fillRule="evenodd"
